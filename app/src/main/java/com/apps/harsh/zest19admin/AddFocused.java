...
public class AddFocused extends AppCompatActivity {
    ...
    private static final String TAG = "AddFocusedActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        datePickerDialog = new DatePickerDialog(AddFocused.this, new DatePickerDialog.OnDateSetListener() {
            @Override
        ...
        timePickerDialog = new TimePickerDialog(AddFocused.this, new TimePickerDialog.OnTimeSetListener() {
...
//                mTimePicker.setTitle("Select Time");
                ...
                if(team11.getText().toString().equals("") || (datepicker.getText().toString()).equals("") || (time.getText().toString()).equals("")){
                    ...
                    if (team2.length() > 0 && team1.length() > 0) {
                        if (id.length() > 0) {
                            ...
                            updateMatch(id, team1, team2, date, ti, place, game_ty, match_ty);
                        } else {
                            //Toast.makeText(AddSchedule.this, "Insert: " + team1 + team2 + ti + date + match_ty + game_ty + place, Toast.LENGTH_LONG).show();
                            addMatch(team1, team2, date, ti, place, game_ty, match_ty);
                        }
                    }
    ...
    private void updateMatch(String id, String team1, String team2, String date, String ti, String place, String game_ty, String match_ty) {
    ...
    private void addMatch(String team1, String team2, String date, String ti, String place, String game_ty, String match_ty) {
